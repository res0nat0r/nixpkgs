...
in
{
  ...
  node-gyp-build = nodeEnv.buildNodePackage {
    ...
    version = "3.2.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/node-gyp-build/-/node-gyp-build-3.2.0.tgz";
      sha1 = "283be074924aabb9240ce3f880c7ca0c8e7a00dc";
    };
    buildInputs = globalBuildInputs;
    meta = {
  ...
  uglify-js = nodeEnv.buildNodePackage {
    ...
    version = "3.0.11";
    src = fetchurl {
      url = "https://registry.npmjs.org/uglify-js/-/uglify-js-3.0.11.tgz";
      sha1 = "81f594b9a24dad76e39da92f8f06e5b3bc8c2e11";
    };
    dependencies = [
      sources."commander-2.9.0"
      sources."source-map-0.5.6"
